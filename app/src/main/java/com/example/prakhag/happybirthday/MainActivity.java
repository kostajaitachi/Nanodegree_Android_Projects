package com.example.prakhag.happybirthday;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void makeYourOwnMaterialClicked(View v){
        Toast.makeText(getBaseContext(),"This button will launch my Make Your Own Material App!",Toast.LENGTH_LONG).show();
    }
